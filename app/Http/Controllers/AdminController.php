...
class AdminController extends Controller
{
    ...
    public function custom_registration(Request $request)
    {
        ...
        $user->email = $request->register_type == 'email' ? $request->email : null;
        $user->phone = $request->register_type == 'phone' ? $request->phone : null;
        $user->type = 2;
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.index')->with('success', 'One admin added !');
    }
    ...
    public function about_us_setting_store(Request $request)
    {
        ...
        return back()->with('success', 'About Us Settings has been updated !');
