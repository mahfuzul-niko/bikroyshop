...
Route::get('/ajax_trending_now', [App\Http\Controllers\PageController::class, 'ajax_trending_now'])->name('ajax.trending.now');
Route::get('/ajax_category_wise_product', [App\Http\Controllers\PageController::class, 'ajax_category_wise_product'])->name('ajax.category_wise_product');
...
Route::group(['prefix' => '/home', 'middleware' => ['auth', 'verified', 'adminAuth']], function(){
	...
	Route::group(['prefix' => 'wholesale', 'as' => 'wholesale.'], function(){
	    Route::get('/', [App\Http\Controllers\WholesaleController::class, 'wholesaleQuery'])->name('index');
		Route::get('/edit/{id}', [App\Http\Controllers\WholesaleController::class, 'wholesaleEdit'])->name('edit');
		Route::post('/change-status/{id}', [App\Http\Controllers\WholesaleController::class, 'change_wholesale_status'])->name('status.change');
	});
	...
	Route::group(['prefix' => 'order', 'as' => 'order.'], function(){
		...
		/* Pathao Courier */
		Route::get('/getZoneInfoFromCourierType', [App\Http\Controllers\DeliveryCourierInfoController::class, 'getZoneInfoFromCourierType'])->name('getZoneInfoFromCourierType');
		Route::get('/pathaoCityToZoneList', [App\Http\Controllers\DeliveryCourierInfoController::class, 'pathaoCityToZoneList'])->name('pathao.city.to.zone');
		Route::get('/pathaoZoneToAreaList', [App\Http\Controllers\DeliveryCourierInfoController::class, 'pathaoZoneToAreaList'])->name('pathao.zone.to.area');
		Route::post('/deliveryQueryStore', [App\Http\Controllers\DeliveryCourierInfoController::class, 'storeDeliveryCourierData'])->name('delivery.query.store');
	...
	Route::group(['prefix' => 'image-upload', 'as' => 'image.upload.'], function(){                                                        
		...
		Route::post('/update/{id}', [App\Http\Controllers\ImageController::class, 'update'])->name('update');
		Route::post('/destroy/{id}', [App\Http\Controllers\ImageController::class, 'destroy'])->name('destroy');
	});
