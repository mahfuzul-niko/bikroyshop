...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->string('bn_title')->nullable()->index();
            ...
            $table->longText('feature')->nullable()->index();
            $table->longText('bn_feature')->nullable()->index();
            $table->longText('description')->nullable()->index();
            $table->longText('bn_description')->nullable()->index();
