            ...
            <div class="row mb-9">
                ...
                <div class="col-lg-7 pr-lg-4 mb-4 p-3">
                    ...
                    <div class="row gutter-sm">
                        <div class="col-xs-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="checkout__input--field border-radius-5" name="name" value="{{ optional(Auth::user())->name . ' ' . optional(Auth::user())->last_name }}" required>
                            </div>
                        </div>
                    ...
                    <div class="row gutter-sm">
                        <div class="col-md-12 mb-3">
                            <div class="checkout__input--list checkout__input--select select">
                                <label class="checkout__select--label"> {{ __('messages.Shipping area') }} @required </label>
                        ...
                        <div class="col-md-6 mb-3 d-none">
                            <div class="checkout__input--list checkout__input--select select">
                                <label class="checkout__select--label">Area @required</label>
                                <select name="area_id" id="areas" class="checkout__input--select__field border-radius-5 @error('area_id') is-invalid @enderror" >
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="shipping_address" id="" cols="30" rows="10" required placeholder="{{ __('messages.House number and street name') }}" class="checkout__input--field border-radius-5 mb-2" >{{ optional(Auth::user())->address }}</textarea>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <h4 class="mb-0 text-success"><b>Payment Method: </b> Cash on Delivery</h4>
                    ...
                    <div class="checkout__content--step__footer d-flex align-items-center">
                        <button class="continue__shipping--btn primary__btn border-radius-5" type="submit"> {{ __('messages.Confirm Order') }}</button>
                        <a class="previous__link--content" href="{{route('products')}}"> {{ __('messages.Return to shop') }}</a>
                    </div>
                </form>
                </div>
