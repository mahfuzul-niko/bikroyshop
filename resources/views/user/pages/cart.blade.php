...
@section('title') {{ __('messages.Shopping Cart') }} @endsection
                                ...
                                <table class="cart__table--inner">
                                    <thead class="cart__table--header">
                                        <tr class="cart__table--header__items">
                                            <th width="45%" class="cart__table--header__list">
                                                {{ __('messages.Product') }}
                                            </th>
                                    ...
                                    <tbody class="cart__table--body">
                                        ...
                                        <tr class="cart__table--body__items mb-2">
                                            <td class="cart__table--body__list">
                                                <div class="cart__product d-flex align-items-center">
                                                    ...
                                                    <div class="cart__content">
                                                        <h4 class="cart__content--title"><a href="{{route('single.product', [$product_info->id, Str::slug($product_info->title)])}}">
                                            ...
                                            <td class="cart__table--body__list">
                                                <span class="cart__price end">{{ __currency().bnConv('bnComNum',optional($cart->options)->single_price * $cart->qty) }}</span>
                                            </td>
                                        </tr>
                                        @endif
                                        @endforeach
                                        @else
                                            <tr>
                                                <td colspan="5"><div class="minicart__product--items text-center"><h3 class="py-5 px-2"><b>
                                                    {{ __('messages.Your cart is empty') }}</b><h3></div></td>
                                            </tr>
                                        @endif
                                    </tbody>
                                </table> 
                            ...
                            <div class="cart__summary border-radius-10">
                                <div class="coupon__code mb-30">
                                    ...
                                    <div class="coupon__code--field">
                                        <form class="coupon coupon__code--field d-flex" action="{{ route('coupon.apply') }}" method="POST">
                                            @csrf
                                            <label>
                                                <input required style="width: 150px !important;" class="coupon__code--field__input border-radius-5" name="code" placeholder="{{ __('messages.Coupon Code') }}" type="text">
                                            </label>
                                ...
                                <div class="cart__summary--total mb-20">
                                    <table class="cart__summary--total__table">
                                        <tbody>
                                            ...
                                            <tr class="cart__summary--total__list">
                                                <td class="cart__summary--total__title text-left">{{ __('messages.Discount') }}</td>
                                                <td class="cart__summary--amount text-right">{{  __currency().bnConv('bnComNum',$discount) }}</td>
                                            </tr>
                                            <tr class="cart__summary--total__list">
                                                <td class="cart__summary--total__title text-left">{{ __('messages.Total') }}</td>
                                                <td class="cart__summary--amount text-right"><?php $subTotal=$total - $discount; ?>{{  __currency().bnConv('bnComNum',$subTotal) }}</td>
                                            </tr>
                                ...
                                <div class="cart__summary--footer">
                                    <ul class="d-flex justify-content-between">
                                        <li></li>
                                        <li><a class="cart__summary--footer__btn primary__btn checkout" href="{{ route('checkout') }}">{{ __('messages.PROCEED TO CHECKOUT') }}</a></li>
                                    </ul>
                                </div>
                            </div> 
                        </div>
