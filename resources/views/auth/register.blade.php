                            ...
                            <div class="col">
                                <div class="account__login register">
                                    ...
                                    <div class="account__login--inner">
                                        <input class="account__login--input" placeholder="Please enter your Full Name" name="name" value="{{old('name')}}" required type="text">
                                        ...
                                        <input class="account__login--input" placeholder="Enter Password [Min: 8]" name="password" required type="password">
                                        <input class="account__login--input" placeholder="Enter Confirm Password" required name="password_confirmation" type="password">
