                                    ...
                                    <div class="row">
                                      <div class="col-md-12">
                                        <div class="form-group">
                                          <label>Brand Title(English) @required</label>
                                        ...
                                        <div class="form-group">
                                          <label>Brand Title(Bangla)</label>
                                          <input type="text" name="bn_title" class="form-control @error('bn_title') is-invalid @enderror" Value="{{ $brand->bn_title }}">
                                          @error('bn_title')
                                              <span class="invalid-feedback" role="alert">
                                                  <strong>{{ $message }}</strong>
                                              </span>
