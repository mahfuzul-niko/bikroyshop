                            ...
                            <div class="row">
                              <div class="col-md-12">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" name="bn_name" class="form-control @error('bn_name') is-invalid @enderror" Value="{{ $district->bn_name }}">
                                  @error('bn_name')
                                      <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
                  ...
                  <div class="modal-body">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        ...
                        <div class="form-group">
                          <label>District Name(Bangla)</label>
                          <input type="text" name="bn_name" class="form-control @error('bn_name') is-invalid @enderror" placeholder="Bangla Name">
                          @error('bn_name')
                              <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
