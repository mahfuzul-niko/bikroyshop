			...
			<form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
			  ...
			  <div class="row">
			    <div class="form-group col-md-6">
				    <label class="col-form-label"><b>Title(English)</b> @required </label>
				    <div class="">
				...
				<div class="form-group col-md-6">
				    <label class="col-form-label"><b>Title(Bangla)</b></label>
				    <div class="">
				      <input type="text" name="bn_title" value="{{ old('bn_title') }}" class="form-control @error('title') is-invalid @enderror">
			            @error('bn_title')
			                <span class="invalid-feedback" role="alert">
			                    <strong>{{ $message }}</strong>
			                </span>
					...
					<div class="row">
						<div class="col-md-8">
							<div class="row">
								...
								<div class="form-group col-md-4">
									<label class="col-form-label"><b>Thumbnail ( 600px X 600px )</b> @required </label>
									<div class="">
								...
								{{-- <div class="form-group col-md-4">
									<label class="col-form-label"><b>Gallery</b> @required </label>
									<div class="">
						...
						<div class="col-md-4">
							<div class="shadow rounded p-2 border border-success">
								<h5 class="fw-bold border-bottom bg-info text-light p-2">Select Categories  @required </h5>
						...
						<div class="col-md-12 row">
							...
							<div class="">
								<div class="form-group">
                                    <div class="form-check form-check-inline bg-default ml-2 px-3 p-2 rounded-pill text-dark border border-primary">
                                    ...
                                    <div class="form-check form-check-inline bg-default px-3 ml-2 p-2 rounded-pill text-dark border border-success">
					...
					<div class="shadow p-2">
						<div class="form-group">
							...
							<label for="is_tranding" class="mr-3">
								<input type="checkbox" name="is_tranding" value="1" checked id="is_tranding">
								{{-- Tranding Now --}}
								Add to Hot Deal
							</label>

							{{-- <label for="todays_deal" class="mr-3">
								<input type="checkbox" name="todays_deal" value="1" checked id="todays_deal">
								Today's Deal
							</label> --}}
				...
				<div class="form-group col-md-12">
					...
					<div class="">
					<input type="text" name="video_link" value="{{ old('video_link') }}" placeholder="https://www.youtube.com/watch?v=jCKt02NGjfM" class="form-control @error('video_link') is-invalid @enderror">
						@error('video_link')
							<span class="invalid-feedback" role="alert">
								<strong>{{ $message }}</strong>
							</span>
				...
				<div class="form-group col-md-6">
				    ...
				    <div class="">
				    	<textarea class="form-control @error('feature') is-invalid @enderror" name="feature"></textarea>
				    </div>
				</div>
				<div class="form-group col-md-6">
				    <label class="col-form-label">Description(Bangla)</label>
				    <div class="">
				    	<textarea class="form-control @error('bn_feature') is-invalid @enderror" name="bn_feature"></textarea>
				    </div>
				</div>
				<div class="form-group col-md-6">
				...
				<div class="form-group col-md-6">
				    <label class="col-form-label"><b>Processing Time(Bangla)</b></label>
				    <div class="">
				    	<textarea class="form-control @error('bn_description') is-invalid @enderror" name="bn_description">{{ old('bn_description') }}</textarea>
				    </div>
				</div>
