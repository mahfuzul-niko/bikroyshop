      ...
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-md-6 text-right">
            <a href="{{ route('category.create') }}" class="btn btn-outline-primary"><i class="fas fa-plus"></i> Create Category</a>
          </div>
        </div>
            ...
            @foreach($categories as $category)
              <tr>
                <td>
                  {{ $category->title }} <br>
                  {{ $category->bn_title }} 
                  <br><img class="shadow rounded p-1" src="{{ asset('images/category/'.$category->image ) }}" width="50px">
                  <br>
                ...
                <td>
                  <a href="{{ route('category.edit', $category->id) }}" class="btn btn-outline-primary btn-sm mb-2" title="Edit"><i class="fas fa-edit"></i></a>
                  <a href="#deleteModal{{ $category->id }}" class="btn btn-outline-danger btn-sm mb-2" data-toggle="modal" title="Delete"><i class="fas fa-trash"></i></a>
                </td>
                <td>
                  ...
                  <table class="table">
                    <thead class="bg-gray text-dark">
                      <tr>
                        <th width="30%">Sub Category Title</th>
                        <th width="">Position</th>
                        <th scope="col">Action</th>
                        <th width="63%" scope="col">Sub Sub Category</th>
                      </tr>
                    </thead>
                    <tbody>
                      @foreach($category->child as $p_category)
                        <tr>
                          ...
                          <td>
                            <a href="{{ route('category.edit', $p_category->id) }}" class="btn btn-outline-primary btn-sm mb-2" title="Edit"><i class="fas fa-edit"></i></a>
                            <a href="#deleteModal{{ $p_category->id }}" class="btn btn-outline-danger btn-sm mb-2" data-toggle="modal" title="Delete"><i class="fas fa-trash"></i></a>
