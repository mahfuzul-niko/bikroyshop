                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="English Title" value="{{ $category->title }}" required>
                        @error('title')
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="bn_title" class="form-control @error('bn_title') is-invalid @enderror" placeholder="Bangla Title" value="{{ $category->bn_title }}">
                        @error('bn_title')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label>Thumbnail ( 500px X 393px )</label>
