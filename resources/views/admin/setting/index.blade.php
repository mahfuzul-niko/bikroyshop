                 ...
                 <div class="row">
                  <div class="col-md-12 p-2">
                    <div class="row shadow rounded border p-2">
                        <div class="col-md-12"><h3><b>Shop Information</b></h3></div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                          <div class="form-group">
                            <label>Website Logo @required </label>
                            ...
                            @enderror
                            <img class="bg-gray mt-2 shadow rounded border p-1" width="50%" src="{{ asset('images/website/'. optional($setting)->header_logo) }}">
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            <label>Invoice Logo @required </label>
                            ...
                            @enderror
                            <img class="bg-gray mt-2 shadow rounded border p-1" width="50%" src="{{ asset('images/website/'. optional($setting)->footer_logo) }}">
                          </div>
                        </div>
                        <div class="col-md-4">
                          <div class="form-group">
                            ...
                            @error('favicon')
                              ...
                              @enderror
                              <img class="bg-gray mt-2 shadow rounded border p-1" width="100px" src="{{ asset('images/website/'. optional($setting)->favicon) }}">
                          </div>
                        </div>                 
                        <div class="col-md-6">
                          <div class="form-group">
                  ...
                  <div class="col-md-12 p-2">
                    <div class="row shadow rounded border p-2">
                        <div class="col-md-12"><h3><b>Google</b></h3></div>
                        <div class="col-md-12">
                          <div class="form-group">
                            <label>Google Map Link</label>
                            <input type="text" name="google_map_link" value="{{ optional($setting)->google_map_link }}" class="form-control @error('google_map_link') is-invalid @enderror">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input type="text" name="google_map_embed" value="{{ optional($setting)->google_map_embed }}" class="form-control @error('google_map_embed') is-invalid @enderror">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input type="text" name="google_tag_manager_head" value="{{ optional($setting)->google_tag_manager_head }}" class="form-control @error('google_tag_manager_head') is-invalid @enderror">
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            ...
                            <input type="text" name="google_tag_manager_body" value="{{ optional($setting)->google_tag_manager_body }}" class="form-control @error('google_tag_manager_body') is-invalid @enderror">
